...
@Autonomous(name = "Red - Block Side - Get 1 Stone - v20", group = "a1")


public class EdmontonRedAutoBlockStart extends LinearOpMode {
    ...
    int testxStart = 144, testyStart = 185, testwidth = 670, testheight = 112;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(blockResult==1){telemetry.addLine("Right Side");}
        if(blockResult==2){telemetry.addLine("Middle");}
        if(blockResult==3){telemetry.addLine("Left Side");}
        telemetry.update();
        ...
        if (opModeIsActive()) {
            ...
            if(blockResult == 3) { timeStrafe(600, 0.6);}
